...
export function TrailerSection() {
  return (
    <section className="relative py-32 min-h-[600px] w-full overflow-hidden bg-ceres-black flex items-center">
      ...
      {/* Animated glow orbs */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-ceres-blue/5 rounded-full blur-[120px] pointer-events-none z-10" />
        ...
        <ScrollReveal>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-3 mb-8">
              <span className="h-px w-10 bg-ceres-blue/60" />
              <span className="font-mono text-xs tracking-[0.25em] text-ceres-blue uppercase font-bold flex items-center gap-2">
            ...
            <h2 className="font-display text-5xl md:text-7xl lg:text-8xl text-white drop-shadow-2xl mb-8 leading-none">
              SOMETHING<br />
            ...
            {/* Status indicator */}
            <div className="inline-flex items-center gap-4 px-6 py-4 rounded-2xl border border-ceres-border bg-ceres-surface/50 backdrop-blur-sm">
              ...
              <span className="w-px h-4 bg-ceres-border" />
              <span className="flex items-center gap-2">
